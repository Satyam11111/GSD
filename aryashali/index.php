...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">AryaShali</a>
			</div>
	...
	<!-- Slider Begins -->
	 ...
	 <!-- <div class="one-time">
	    <div><img src="assets/images/aryashali_official.png"></div>
	    <div><img src="assets/images/style_guide.png"></div>
	    <div><img src="assets/images/banner_1.png"></div>
  	</div> -->
				...
				<div class="panel panel-info">
					<div class="panel-heading text-center">--Featured Products--
						<div class='pull-right'>
								Sort: &nbsp;&nbsp;&nbsp; <a href="#" id='pop_sort'>Popularity</a>
							</div>
					</div>
